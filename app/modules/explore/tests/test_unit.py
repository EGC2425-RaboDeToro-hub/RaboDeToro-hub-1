...
def test_filter_by_date_range(explore_service):
    with patch.object(explore_service.repository, 'filter') as mock_filter:
        ...
        mock_filter.assert_called_once_with(
            "", "newest", "any", [], after_date=after_date, before_date=before_date, min_size=None, max_size=None, number_of_features="", number_of_models=""
        )
...
def test_filter_by_size_range(explore_service):
    with patch.object(explore_service.repository, 'filter') as mock_filter:
        ...
        assert len(result) == 2
        mock_filter.assert_called_once_with(
            "", "newest", "any", [], after_date=None, before_date=None, min_size=min_size, max_size=max_size, number_of_features="", number_of_models=""
        )
...
def test_filter_by_date_and_size_range(explore_service):
    with patch.object(explore_service.repository, 'filter') as mock_filter:
        ...
        mock_filter.assert_called_once_with(
            ...
            max_size=max_size, number_of_features="", number_of_models=""
        )
...
def test_filter_by_exact_number_of_features(explore_service):
    with patch.object(explore_service.repository, 'filter') as mock_filter:
        ...
        assert len(result) == 2
        mock_filter.assert_called_once_with(
            "", "newest", "any", [], after_date=None, before_date=None,
            min_size=None, max_size=None, number_of_features="50", number_of_models=""
        )
...
def test_filter_by_exact_number_of_models(explore_service):
    with patch.object(explore_service.repository, 'filter') as mock_filter:
        ...
        mock_filter.assert_called_once_with(
            "", "newest", "any", [], after_date=None, before_date=None,
            min_size=None, max_size=None, number_of_features="", number_of_models="3"
        )
...
def test_filter_by_features_and_models_combined(explore_service):
    with patch.object(explore_service.repository, 'filter') as mock_filter:
        ...
        mock_filter.assert_called_once_with(
            "", "newest", "any", [], after_date=None, before_date=None,
            min_size=None, max_size=None, number_of_features="20", number_of_models="4"
        )
...
def test_filter_sorting_oldest_first(explore_service):
    with patch.object(explore_service.repository, 'filter') as mock_filter:
        ...
        assert result == mock_datasets
        mock_filter.assert_called_once_with(
            "", "oldest", "any", [], after_date=None, before_date=None,
            min_size=None, max_size=None, number_of_features="", number_of_models=""
        )
